        ...
        <div className="about-area">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 offset-lg-1 grid  col-md-12 col-12 abt">
                        <div className="about-text">
                            ...
                            <p>At Alma Foundation, our mission is to create a better world by providing support 
                                and resources to those in need. We are committed to making a positive impact through 
                                community-driven initiatives, education, healthcare, and emergency relief. With the help
                                 of our dedicated volunteers and generous donors, we strive to bring hope and change to lives every day.</p>
